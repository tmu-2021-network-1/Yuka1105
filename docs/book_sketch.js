...
function draw() {
  ...
  a = -$(window).scrollTop() * 0.0035 + 60 ; //初期角度0
  console.log(v);
  console.log($(window).scrollTop());
  console.log("3");
  if(a_switch == true){
  ...
  if(a_switch2 == true){
    ...
    scroll_y +=v;
    v += g;
    if($(window).scrollTop() < 26000 && bounce_count == 1){
      bounce_count ++;
      console.log(v);
      console.log($(window).scrollTop());
      console.log("7");
    }
    if($(window).scrollTop() > 29000 && bounce_count==2){
      a_switch2 = false;
      a_switch3 = true;
      v = 0;
      console.log(v);
  ...
  if(a_switch3 == true){
    ...
    if(up == true){
      ...
      console.log(scroll_y);
      console.log("17");
      if($(window).scrollTop() < 25900 && bounce_count2 == 1){
        bounce_count2 ++;
        console.log(v);
        console.log($(window).scrollTop());
        console.log("18");
      }
      if($(window).scrollTop() > 29000 && bounce_count2==2){
        up = false;
        v = 0;
        bounce_count2 = 0;
        bounce_kind = 0;
  ...
  line(rx,ry,rx-50,ry+130);
  image(img,lx-40,ly+55, img.width / 6.5, img.height / 6.5);
  stroke(120,80,80);
  strokeWeight(10);
  strokeJoin(ROUND);
  fill(140,100,60);
